    ...
    window.postMessage(
      {
        ...
        data: {
          id: Date.now(),
          title: "GOUVERNEMENT",
          message: "ANNONCE DU GOUVERNEMENT",
          timeout: 5000,
          advanced: false,
          dark: false,
          url: "casino",
  ...
  return (
    <div className={inUI ? "notifications-container-inui" : "notifications-container"}>
      {process.env.NODE_ENV !== "production" && (
        <button onClick={sendTestNotification} style={{ marginBottom: 8 }}>
          🔔 Test Notification
        </button>
      )}
